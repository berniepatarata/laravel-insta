...
class User extends Authenticatable
{
    ...
    public function isFollowed()
    {
        ...
        //Firstly, we get all the followers of the user ($this->followers()). Then, from that list, search for the Auth user from the follower column (where('follower_id', Auth::user()->id))
    }
